...
class MetricsAPI(object):
    ...
    def ajaxCurrentSessionTotals(self):
        ...
        ret = self.serverRequest('/ADP/SESSIONS/CURRENT/')
    ...
    def ajaxOverallTotalListeningSessions(self):
        ...
        """
        totalSessions = self.serverRequest('/ADP/SESSIONS/TOTAL')
        totalBounced = self.serverRequest('/ADP/SESSIONS/BOUNCED')
    ...
    def ajaxOverallUniqueListeners(self):
        ...
        """
        ret = self.serverRequest('/ADP/LISTENER/TOTAL')
    ...
    def ajaxListeningSessionsForThisHour(self):
        ...
        this hour.
        """
        ret = self.serverRequest('/ADP/SESSIONS/LAST1HOURS/')
    ...
    def ajaxListeningSessionsForToday(self):
        ...
        """
        ret = self.serverRequest('/ADP/SESSIONS/LAST1DAYS/')
    ...
    def ajaxCurrentPlayingSong(self):
        ...
        """
        one_song = self.serverRequest("/ADP/SONGS/PLAYED/?limit=1")
    ...
    def ajaxAvgSessionListeningTime(self):
        ...
        """
        ret = self.serverRequest("/ADP/SESSIONS/AVGLISTENINGTIME/")
    ...
    def ajaxTotalListenerHours(self):
        ...
        """
        ret = self.serverRequest("/ADP/LISTENER/HOURS/")
    ...
    def ajaxAvgListeningSessionsPerUser(self):
        ...
        """
        ret = {}
        ret["Total Listeners"] = float(self.serverRequest("/ADP/LISTENER/TOTAL/")["Total"])
        ret["Total Sessions"] = float(self.serverRequest("/ADP/SESSIONS/TOTAL/")["Total"])
        ret["Total Bounced"] = float(self.serverRequest("/ADP/SESSIONS/BOUNCED/")["Total"])
    ...
    def ajaxLastXminsOfSessions(self):
        ...
        ltm = self.serverRequest("/ADP/SESSIONS/LAST" + str(mins) + "MINS/")
    ...
    def ajaxLastXhoursOfListeners(self):
        ...
        ltm = self.serverRequest("/ADP/SESSIONS/LAST" + str(hours) + "HOURS/")
    ...
    def ajaxLastXdaysOfListeners(self):
        ...
        ltm = self.serverRequest("/ADP/SESSIONS/LAST" + str(days) + "DAYS/")
